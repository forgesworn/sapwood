...
- **Backup & restore** -- back up and recover all three signer secrets: the [identity key](docs/backup-and-restore.md) (12 words on the device, or a [24-word](docs/key-backup.md) backup of an imported nsec/ncryptsec), the operator key, and re-derivable named identities. See the [backup and restore guide](docs/backup-and-restore.md)
